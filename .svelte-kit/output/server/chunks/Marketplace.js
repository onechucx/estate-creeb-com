import { c as create_ssr_component, a as spread, e as escape_object, g as createEventDispatcher, v as validate_component, d as add_attribute, f as escape, b as each } from "./ssr.js";
import { I as InformationCircleIcon } from "./InformationCircleIcon.js";
import { M as MagnifyingGlassIcon } from "./MagnifyingGlassIcon.js";
  ...
  return `${``} <div class="space-y-6">${validate_component(Card, "Card").$$render($$result, {}, {}, {
    default: () => {
      return `<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4"><div class="relative lg:col-span-2">${validate_component(MagnifyingGlassIcon, "MagnifyingGlassIcon").$$render(
        ...
        {},
        {}
      )}</button></div></div></div> <div class="mt-4 border-b border-brand-border dark:border-dark-border"><nav class="-mb-px flex space-x-4 overflow-x-auto">${each(categories, (category) => {
