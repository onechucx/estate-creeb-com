...
const userRole = writable("User");
const toast = writable(null);
const userSubscriptions = writable({ community: true, estate: false });
const user = writable({
  id: "user-1",
  name: "John Doe",
...
const pastDate = (days) => new Date(Date.now() - days * 24 * 60 * 60 * 1e3).toISOString();
[
  {
    id: "REQ001",
    type: "Community",
...
const initialListings = [
  {
    ...
    description: "Spacious 5-bedroom villa with a pool, modern kitchen, and a serene environment perfect for families. Comes with a 2-car garage and a beautiful garden. Recently renovated with top-quality materials.",
  ...
  },
  {
    ...
    description: "Barely used 2022 Toyota Camry, automatic transmission, in perfect condition with only 5,000 miles. Clean title and full service history available.",
    vendorName: "John Doe",
    vendorId: "vendor2",
    isPaid: true,
    dateListed: "2023-10-28T14:30:00Z",
    boostEndDate: new Date(Date.now() + 15 * 24 * 60 * 60 * 1e3).toISOString(),
    status: "Active",
    views: 8200,
    clicks: 310
  },
  {
    ...
    description: "Professional web development for your business. We build responsive, fast, and SEO-friendly websites tailored to your needs.",
  ...
  },
  {
    ...
    description: "A great investment for the future. Full plot of land in a rapidly developing area of Epe, with gazette title.",
    vendorName: "Partner",
    vendorId: "vendor4",
    isPaid: false,
  ...
  },
  {
    ...
    description: "Complete set for a small office, including 4 desks, chairs, and filing cabinets. All in excellent condition.",
  ...
  },
  {
    ...
    description: "Newly renovated 2-bedroom apartment in a secure complex. Perfect for young professionals or a small family.",
    vendorName: "John Doe",
    vendorId: "vendor2",
    isPaid: false,
...
export {
  activeView as a,
  userSubscriptions as b,
  user as c,
  initialListings as i,
  toast as t,
  userRole as u
};
