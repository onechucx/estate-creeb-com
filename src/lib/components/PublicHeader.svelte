...
<header class="bg-brand-surface dark:bg-dark-surface p-4 border-b border-brand-border dark:border-dark-border">
    <div class="container mx-auto flex items-center justify-between">
        ...
        <div class="flex items-center space-x-2">
            <Button type="button" variant="secondary" on:click={onLoginClick} aria-label="Open login dialog" title="Login">Login</Button>
            <Button type="button" variant="primary" aria-label="Sign up" title="Sign up">Sign Up</Button>
        </div>
    </div>
</header>
